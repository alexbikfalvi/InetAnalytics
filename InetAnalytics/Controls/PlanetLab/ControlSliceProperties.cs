...
namespace InetAnalytics.Controls.PlanetLab
{
	...
	public partial class ControlSliceProperties : ControlObjectProperties
	{
		...
		protected override void OnUpdate(int id)
		{
			...
			this.BeginRequest(this.request, CrawlerConfig.Static.PlanetLabUsername, CrawlerConfig.Static.PlanetLabPassword, PlSlice.GetFilter(PlSlice.Fields.SliceId, id));
		}
