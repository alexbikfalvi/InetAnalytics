	...
	public partial class ControlProfileProperties : ThreadSafeControl
	{
		...
		protected virtual void OnProfileSet(Profile oldProfile, Profile newProfile)
		{
			...
			else
			{
				...
				this.radioButtonMale.Checked = newProfile.Gender != null ? newProfile.Gender == InetApi.YouTube.Api.V2.Atom.Gender.Male ? true : false : false;
				this.radioButtonFemale.Checked = newProfile.Gender != null ? newProfile.Gender == InetApi.YouTube.Api.V2.Atom.Gender.Female ? true : false : false;
