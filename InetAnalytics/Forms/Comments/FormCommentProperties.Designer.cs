...
{
	partial class FormCommentProperties
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.control = new InetAnalytics.Controls.Comments.ControlCommentProperties();
			this.SuspendLayout();
			// 
			// buttonClose
			// 
			...
			this.Name = "FormCommentProperties";
			this.ShowIcon = false;
		...
		private Controls.Comments.ControlCommentProperties control;
