...
{
	partial class FormObjectProperties
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.control = new InetAnalytics.Controls.Database.ControlObjectProperties();
			this.SuspendLayout();
			// 
			// buttonClose
			// 
		...
		private Controls.Database.ControlObjectProperties control;
