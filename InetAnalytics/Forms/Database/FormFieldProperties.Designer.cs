...
{
	partial class FormFieldProperties
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.control = new InetAnalytics.Controls.Database.ControlFieldProperties();
			this.SuspendLayout();
			// 
			// buttonClose
			// 
		...
		private Controls.Database.ControlFieldProperties control;
