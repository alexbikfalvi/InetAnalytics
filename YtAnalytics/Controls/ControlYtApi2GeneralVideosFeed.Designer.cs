...
{
	partial class ControlYtApi2GeneralVideosFeed
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ControlYtApi2GeneralVideosFeed));
			...
			this.videoList.VideosPerPageChanged += new System.EventHandler(this.SearchChanged);
			// 
			// viewMenu
			// 
			...
			this.menuItemApi2.Click += new System.EventHandler(this.ViewApiV2);
			// 
			...
			this.menuItemApi3.Click += new System.EventHandler(this.ViewApiV3);
			// 
			// menuItemWeb
			// 
			...
			this.textBoxVideo.TextChanged += new System.EventHandler(this.SearchChanged);
			// 
			// checkBoxView
			// 
			...
			// 
			// ControlYtApi2GeneralVideosFeed
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.Controls.Add(this.splitContainer);
			this.Enabled = false;
			this.Name = "ControlYtApi2GeneralVideosFeed";
