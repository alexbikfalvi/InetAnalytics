...
{
	public delegate void AddVideoCommentEventHandler(string video);

	/// <summary>
	/// A control displaying a list of video comments.
	/// </summary>
	public partial class ControlCommentsVideos : UserControl
	{
		private Crawler crawler;

		private FormAddVideoComment formAdd = new FormAddVideoComment();
		private FormCommentVideo formComment = new FormCommentVideo();

		/// <summary>
		/// Creates a new control instance.
		/// </summary>
		public ControlCommentsVideos()
		{
			InitializeComponent();
			// Default settings.
			this.Dock = DockStyle.Fill;
			this.Visible = false;
			this.formAdd.CommentAdded += new CommentVideoAddEventHandler(this.OnCommentAdded);
		}
