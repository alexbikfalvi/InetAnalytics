...
namespace YtAnalytics.Controls.PlanetLab
{
	...
	public partial class ControlInterfaceProperties : ControlObjectProperties
	{
		...
		protected override void OnUpdate(int id)
		{
			...
			this.BeginRequest(this.request, CrawlerConfig.Static.PlanetLabUsername, CrawlerConfig.Static.PlanetLabPassword, PlInterface.GetFilter(PlInterface.Fields.InterfaceId, id));
		}
