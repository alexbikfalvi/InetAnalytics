...
namespace YtAnalytics.Controls.PlanetLab
{
	...
	public partial class ControlInterfaceTagProperties : ControlObjectProperties
	{
		...
		protected override void OnObjectSet(PlObject obj)
		{
			...
			if (null == tag)
			{
				this.Title = "Interface tag unknown";
		...
		protected override void OnUpdate(int id)
		{
			...
			this.BeginRequest(this.request, CrawlerConfig.Static.PlanetLabUsername, CrawlerConfig.Static.PlanetLabPassword, PlInterfaceTag.GetFilter(PlInterfaceTag.Fields.InterfaceTagId, id));
		}
