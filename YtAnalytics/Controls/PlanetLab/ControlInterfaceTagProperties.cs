...
namespace YtAnalytics.Controls.PlanetLab
{
	...
	{
		private PlRequest request = new PlRequest(PlRequest.RequestMethod.GetInterfaceTags);
		...
		protected override void OnRequestResult(XmlRpcResponse response, RequestState state)
		{
			...
			if ((null == response.Fault) && (null != response.Value))
			{
				...
				PlList<PlInterfaceTag> tags = PlList<PlInterfaceTag>.Create(response.Value as XmlRpcArray);
