...
namespace YtAnalytics.Controls.PlanetLab
{
	...
	{
		private PlRequest request = new PlRequest(PlRequest.RequestMethod.GetPersonTags);
		...
		{
			this.OnTagSet(obj as PlPersonTag);
		}
		...
		protected override void OnCompleteRequest(XmlRpcResponse response)
		{
			...
			if ((null == response.Fault) && (null != response.Value))
			{
				...
				PlList<PlPersonTag> tags = PlList<PlPersonTag>.Create(response.Value as XmlRpcArray);
		...
		protected virtual void OnTagSet(PlPersonTag tag)
		{
