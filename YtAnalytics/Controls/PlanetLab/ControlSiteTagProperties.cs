...
namespace YtAnalytics.Controls.PlanetLab
{
	...
	public partial class ControlSiteTagProperties : ControlObjectProperties
	{
		...
		protected override void OnUpdate(int id)
		{
			...
			this.BeginRequest(this.request, CrawlerConfig.Static.PlanetLabUsername, CrawlerConfig.Static.PlanetLabPassword, PlSiteTag.GetFilter(PlSiteTag.Fields.SiteTagId, id));
		}
