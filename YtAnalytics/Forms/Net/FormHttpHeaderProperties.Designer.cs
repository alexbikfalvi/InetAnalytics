namespace YtAnalytics.Forms.Net
{
	partial class FormHttpHeaderProperties
	{
		...
		private void InitializeComponent()
		{
			...
			this.control = new YtAnalytics.Controls.Net.ControlHttpHeader();
			this.SuspendLayout();
			// 
			// buttonClose
			// 
			...
			this.Name = "FormHttpHeaderProperties";
			this.ShowIcon = false;
		...
		private YtAnalytics.Controls.Net.ControlHttpHeader control;
	}
}