...
{
	partial class FormAddHttpRequestHeader
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.control = new YtAnalytics.Controls.Testing.ControlAddHttpRequestHeader();
			this.SuspendLayout();
			// 
			// buttonCancel
			// 
		...
		private Controls.Testing.ControlAddHttpRequestHeader control;
