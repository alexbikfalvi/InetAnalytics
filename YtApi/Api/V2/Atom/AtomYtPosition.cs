...
{
	/// <summary>
	/// A class representin a yt:position atom.
	/// </summary>
	[Serializable]
	public sealed class AtomYtPosition : Atom
	{
		internal const string xmlPrefix = "yt";
		internal const string xmlName = "position";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomYtPosition(XElement element)
			: base(xmlPrefix, xmlName, element)
		{
			// Set the value.
			this.Value = element.Value.ToUint();
		}
		...
		public static AtomYtPosition Parse(XElement element, bool mandatory)
		{
			...
			return new AtomYtPosition(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomYtPosition ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomYtPosition.Parse(element.Element(AtomYtPosition.xmlPrefix, AtomYtPosition.xmlName), mandatory);
			}
