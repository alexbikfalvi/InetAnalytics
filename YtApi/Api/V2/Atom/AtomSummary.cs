...
{
	/// <summary>
	/// A class representing a summary atom.
	/// </summary>
	[Serializable]
	public sealed class AtomSummary : Atom
	{
		internal const string xmlPrefix = null;
		internal const string xmlName = "summary";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomSummary(XElement element)
		...
		public static AtomSummary Parse(XElement element, bool mandatory)
		{
			...
			return new AtomSummary(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomSummary ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomSummary.Parse(element.Element(AtomSummary.xmlPrefix, AtomSummary.xmlName), mandatory);
			}
