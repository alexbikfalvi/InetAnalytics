...
{
	/// <summary>
	/// A class representing a media:keywords atom.
	/// </summary>
	[Serializable]
	public sealed class AtomMediaKeywords : Atom
	{
		internal const string xmlPrefix = "media";
		internal const string xmlName = "keywords";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomMediaKeywords(XElement element)
		...
		public static AtomMediaKeywords Parse(XElement element, bool mandatory)
		{
			...
			return new AtomMediaKeywords(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomMediaKeywords ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomMediaKeywords.Parse(element.Element(AtomMediaKeywords.xmlPrefix, AtomMediaKeywords.xmlName), mandatory);
			}
