...
{
	/// <summary>
	/// A class representing an app:draft atom.
	/// </summary>
	[Serializable]
	public sealed class AtomAppDraft : Atom
	{
		internal const string xmlPrefix = "app";
		internal const string xmlName = "draft";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomAppDraft(XElement element)
		...
		public static AtomAppDraft Parse(XElement element, bool mandatory)
		{
			...
			return new AtomAppDraft(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomAppDraft ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomAppDraft.Parse(element.Element(AtomAppDraft.xmlPrefix, AtomAppDraft.xmlName), mandatory);
			}
