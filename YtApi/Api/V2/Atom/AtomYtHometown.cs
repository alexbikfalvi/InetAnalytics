...
{
	/// <summary>
	/// A class representing a yt:hometown atom.
	/// </summary>
	[Serializable]
	public sealed class AtomYtHometown : Atom
	{
		internal const string xmlPrefix = "yt";
		internal const string xmlName = "hometown";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomYtHometown(XElement element)
		...
		public static AtomYtHometown Parse(XElement element, bool mandatory)
		{
			...
			return new AtomYtHometown(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomYtHometown ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomYtHometown.Parse(element.Element(AtomYtHometown.xmlPrefix, AtomYtHometown.xmlName), mandatory);
			}
