...
{
	/// <summary>
	/// A class representing a yt:aboutMe atom.
	/// </summary>
	[Serializable]
	public sealed class AtomYtAboutMe : Atom
	{
		internal const string xmlPrefix = "yt";
		internal const string xmlName = "aboutMe";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomYtAboutMe(XElement element)
		...
		public static AtomYtAboutMe Parse(XElement element, bool mandatory)
		{
			...
			return new AtomYtAboutMe(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomYtAboutMe ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomYtAboutMe.Parse(element.Element(AtomYtAboutMe.xmlPrefix, AtomYtAboutMe.xmlName), mandatory);
			}
