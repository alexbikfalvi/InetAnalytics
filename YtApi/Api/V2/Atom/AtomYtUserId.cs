...
{
	/// <summary>
	/// A class representing a yt:userId atom.
	/// </summary>
	[Serializable]
	public sealed class AtomYtUserId : Atom
	{
		internal const string xmlPrefix = "yt";
		internal const string xmlName = "userId";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomYtUserId(XElement element)
		...
		public static AtomYtUserId Parse(XElement element, bool mandatory)
		{
			...
			return new AtomYtUserId(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomYtUserId ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomYtUserId.Parse(element.Element(AtomYtUserId.xmlPrefix, AtomYtUserId.xmlName), mandatory);
			}
