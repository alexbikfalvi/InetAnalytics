...
{
	/// <summary>
	/// A class representing an xmlns:name atom.
	/// </summary>
	[Serializable]
	public sealed class AtomName : Atom
	{
		...
		private AtomName(XElement element)
		...
		public static AtomName Parse(XElement element, bool mandatory)
		{
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomName ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomName.Parse(element.Element(AtomName.xmlPrefix, AtomName.xmlName), mandatory);
			}
