...
{
	/// <summary>
	/// A class representing a yt:hobbies atom.
	/// </summary>
	[Serializable]
	public sealed class AtomYtHobbies : Atom
	{
		internal const string xmlPrefix = "yt";
		internal const string xmlName = "hobbies";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomYtHobbies(XElement element)
		...
		public static AtomYtHobbies Parse(XElement element, bool mandatory)
		{
			...
			return new AtomYtHobbies(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomYtHobbies ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomYtHobbies.Parse(element.Element(AtomYtHobbies.xmlPrefix, AtomYtHobbies.xmlName), mandatory);
			}
