...
{
	/// <summary>
	/// A class representing a yt:countHint atom.
	/// </summary>
	[Serializable]
	public sealed class AtomYtCountHint : Atom
	{
		internal const string xmlPrefix = "yt";
		internal const string xmlName = "countHint";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomYtCountHint(XElement element)
			: base(xmlPrefix, xmlName, element)
		{
			// Set the value.
			this.Value = element.Value.ToInt(NumberStyles.AllowThousands, -1);
		}
		...
		public static AtomYtCountHint Parse(XElement element, bool mandatory)
		{
			...
			return new AtomYtCountHint(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomYtCountHint ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomYtCountHint.Parse(element.Element(AtomYtCountHint.xmlPrefix, AtomYtCountHint.xmlName), mandatory);
			}
