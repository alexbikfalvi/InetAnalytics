...
{
	/// <summary>
	/// A class representing a yt:books atom.
	/// </summary>
	[Serializable]
	public sealed class AtomYtBooks : Atom
	{
		internal const string xmlPrefix = "yt";
		internal const string xmlName = "books";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomYtBooks(XElement element)
		...
		public static AtomYtBooks Parse(XElement element, bool mandatory)
		{
			...
			return new AtomYtBooks(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomYtBooks ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomYtBooks.Parse(element.Element(AtomYtBooks.xmlPrefix, AtomYtBooks.xmlName), mandatory);
			}
