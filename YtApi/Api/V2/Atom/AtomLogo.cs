...
{
	/// <summary>
	/// A class representing an xmlns:logo atom.
	/// </summary>
	[Serializable]
	public sealed class AtomLogo : Atom
	{
		internal const string xmlPrefix = null;
		internal const string xmlName = "logo";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomLogo(XElement element)
		...
		public static AtomLogo Parse(XElement element, bool mandatory)
		{
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomLogo ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomLogo.Parse(element.Element(AtomLogo.xmlPrefix, AtomLogo.xmlName), mandatory);
			}
