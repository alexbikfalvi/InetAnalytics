...
{
	/// <summary>
	/// A class representing a yt:uploaderId atom.
	/// </summary>
	[Serializable]
	public sealed class AtomYtUploaderId : Atom
	{
		internal const string xmlPrefix = "yt";
		internal const string xmlName = "uploaderId";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomYtUploaderId(XElement element)
		...
		public static AtomYtUploaderId Parse(XElement element, bool mandatory)
		{
			...
			return new AtomYtUploaderId(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomYtUploaderId ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomYtUploaderId.Parse(element.Element(AtomYtUploaderId.xmlPrefix, AtomYtUploaderId.xmlName), mandatory);
			}
