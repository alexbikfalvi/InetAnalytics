...
{
	/// <summary>
	/// A classs representing a yt:firstReleased atom.
	/// </summary>
	[Serializable]
	public sealed class AtomYtFirstReleased : Atom
	{
		internal const string xmlPrefix = "yt";
		internal const string xmlName = "firstReleased";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomYtFirstReleased(XElement element)
			: base(xmlPrefix, xmlName, element)
		{
			// Set the value.
			this.Value = element.Value.ToDateTime();
		}
		...
		public static AtomYtFirstReleased Parse(XElement element, bool mandatory)
		{
			...
			return new AtomYtFirstReleased(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomYtFirstReleased ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomYtFirstReleased.Parse(element.Element(AtomYtFirstReleased.xmlPrefix, AtomYtFirstReleased.xmlName), mandatory);
			}
