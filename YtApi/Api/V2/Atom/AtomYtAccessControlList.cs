...
{
	/// <summary>
	/// A class representing a list of yt:accessControl atoms.
	/// </summary>
	public sealed class AtomYtAccessControlList : IEnumerable<AtomYtAccessControl>
	{
		...
		private AtomYtAccessControlList(IEnumerable<XElement> elements)
		{
			foreach (XElement element in elements)
			{
				this.categories.Add(AtomYtAccessControl.Parse(element, true));
			}
		}
		...
		public static AtomYtAccessControlList Parse(IEnumerable<XElement> elements)
		{
			// If the elements are null, throw an exception.
			if (null == elements) throw new ArgumentNullException("elements");

			// Return a new atom instance.
			return new AtomYtAccessControlList(elements);
		}
		...
		/// <returns>The atom list.</returns>
		public static AtomYtAccessControlList ParseChildren(XElement element)
		{
			// Parse the children elements.
			return AtomYtAccessControlList.Parse(element.Elements(AtomYtAccessControl.xmlPrefix, AtomYtAccessControl.xmlName));
		}
		...
		/// </summary>
		/// <returns>The enumerator.</returns>
		public IEnumerator<AtomYtAccessControl> GetEnumerator()
		{
