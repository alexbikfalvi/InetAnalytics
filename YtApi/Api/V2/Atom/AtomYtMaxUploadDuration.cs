...
{
	/// <summary>
	/// A class representing a yt:company atom.
	/// </summary>
	[Serializable]
	public sealed class AtomYtMaxUploadDuration : Atom
	{
		internal const string xmlPrefix = "yt";
		internal const string xmlName = "maxUploadDuration";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomYtMaxUploadDuration(XElement element)
			: base(xmlPrefix, xmlName, element)
		{
			// Set the attributes.
			this.Seconds = element.Attribute("seconds").Value.ToInt();
		}
		...
		public static AtomYtMaxUploadDuration Parse(XElement element, bool mandatory)
		{
			...
			return new AtomYtMaxUploadDuration(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomYtMaxUploadDuration ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomYtMaxUploadDuration.Parse(element.Element(AtomYtMaxUploadDuration.xmlPrefix, AtomYtMaxUploadDuration.xmlName), mandatory);
			}
