...
namespace InetApi.Net.Core.Dns
{
	...
	public class TSigRecord : DnsRecordBase
	{
		...
		internal override void ParseRecordData(byte[] resultData, int startPosition, int length)
		{
			...
			this.TimeSigned = ParseDateTime(resultData, ref startPosition);
			this.Fudge = TimeSpan.FromSeconds(DnsMessageBase.ParseUShort(resultData, ref startPosition));
			int macSize = DnsMessageBase.ParseUShort(resultData, ref startPosition);
			this.Mac = DnsMessageBase.ParseByteData(resultData, ref startPosition, macSize);
			this.OriginalID = DnsMessageBase.ParseUShort(resultData, ref startPosition);
			...
			this.OtherData = DnsMessageBase.ParseByteData(resultData, ref startPosition, otherDataSize);
		}		
