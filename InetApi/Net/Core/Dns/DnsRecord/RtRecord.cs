...
{
	/// <summary>
	/// <para>Route through record</para> <para>Defined in <see cref="http://tools.ietf.org/html/rfc1183">RFC 1183</see>.</para>
	/// </summary>
	public class RtRecord : DnsRecordBase
	{
			...
			: base(name, RecordType.Rt, RecordClass.INet, timeToLive)
		{
			...
			this.IntermediateHost = intermediateHost ?? String.Empty;
		}
		...
		{
			get { return this.IntermediateHost.Length + 4; }
		}
		...
		internal override void ParseRecordData(byte[] resultData, int startPosition, int length)
		{
			...
			this.IntermediateHost = DnsMessageBase.ParseDomainName(resultData, ref startPosition);
		}
		...
		protected internal override void EncodeRecordData(byte[] messageData, int offset, ref int currentPosition, Dictionary<string, ushort> domainNames)
		{
			...
			DnsMessageBase.EncodeDomainName(messageData, offset, ref currentPosition, this.IntermediateHost, false, domainNames);
		}
	}
}