...
namespace ARSoft.Tools.Net.Dns
{
	...
	public class PtrRecord : DnsRecordBase
	{
		...
		{
			this.PointerDomainName = pointerDomainName ?? String.Empty;
		}
		...
		{
			get { return this.PointerDomainName.Length + 2; }
		}
		...
		{
			this.PointerDomainName = DnsMessageBase.ParseDomainName(resultData, ref startPosition);
		}
		...
		{
			DnsMessageBase.EncodeDomainName(messageData, offset, ref currentPosition, this.PointerDomainName, true, domainNames);
		}
	}
}