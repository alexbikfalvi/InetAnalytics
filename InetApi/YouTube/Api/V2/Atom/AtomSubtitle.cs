...
{
	/// <summary>
	/// A class representing an xmlns:subtitle atom.
	/// </summary>
	[Serializable]
	public sealed class AtomSubtitle : Atom
	{
		internal const string xmlPrefix = null;
		internal const string xmlName = "subtitle";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomSubtitle(XElement element)
		...
		public static AtomSubtitle Parse(XElement element, bool mandatory)
		{
			...
			return new AtomSubtitle(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomSubtitle ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomSubtitle.Parse(element.Element(AtomSubtitle.xmlPrefix, AtomSubtitle.xmlName), mandatory);
			}
