...
{
	/// <summary>
	/// A class representing a yt:occupation atom.
	/// </summary>
	[Serializable]
	public sealed class AtomYtOccupation : Atom
	{
		internal const string xmlPrefix = "yt";
		internal const string xmlName = "occupation";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomYtOccupation(XElement element)
		...
		public static AtomYtOccupation Parse(XElement element, bool mandatory)
		{
			...
			return new AtomYtOccupation(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomYtOccupation ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomYtOccupation.Parse(element.Element(AtomYtOccupation.xmlPrefix, AtomYtOccupation.xmlName), mandatory);
			}
