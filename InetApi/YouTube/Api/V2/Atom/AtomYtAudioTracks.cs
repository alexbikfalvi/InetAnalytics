...
{
	/// <summary>
	/// A class representing a yt:audioTracks atom.
	/// </summary>
	[Serializable]
	public sealed class AtomYtAudioTracks : Atom
	{
		internal const string xmlPrefix = "yt";
		internal const string xmlName = "audioTracks";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomYtAudioTracks(XElement element)
		...
		public static AtomYtAudioTracks Parse(XElement element, bool mandatory)
		{
			...
			return new AtomYtAudioTracks(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomYtAudioTracks ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomYtAudioTracks.Parse(element.Element(AtomYtAudioTracks.xmlPrefix, AtomYtAudioTracks.xmlName), mandatory);
			}
