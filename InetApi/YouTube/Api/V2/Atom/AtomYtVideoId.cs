...
{
	/// <summary>
	/// A class representing a yt:videoId atom.
	/// </summary>
	[Serializable]
	public sealed class AtomYtVideoId : Atom
	{
		internal const string xmlPrefix = "yt";
		internal const string xmlName = "videoid";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomYtVideoId(XElement element)
		...
		public static AtomYtVideoId Parse(XElement element, bool mandatory)
		{
			...
			return new AtomYtVideoId(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomYtVideoId ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomYtVideoId.Parse(element.Element(AtomYtVideoId.xmlPrefix, AtomYtVideoId.xmlName), mandatory);
			}
