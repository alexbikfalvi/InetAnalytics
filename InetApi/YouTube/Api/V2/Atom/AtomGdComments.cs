...
{
	/// <summary>
	/// A class representing a gd:comments atom.
	/// </summary>
	[Serializable]
	public sealed class AtomGdComments : Atom
	{
		internal const string xmlPrefix = "gd";
		internal const string xmlName = "comments";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomGdComments(XElement element)
			: base(xmlPrefix, xmlName, element)
		{
			// Set the optional elements.
			this.FeedLink = AtomGdFeedLink.ParseChild(element, true);
		}
		...
		public static AtomGdComments Parse(XElement element, bool mandatory)
		{
			...
			return new AtomGdComments(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomGdComments ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomGdComments.Parse(element.Element(AtomGdComments.xmlPrefix, AtomGdComments.xmlName), mandatory);
			}
		...
		// Elements.
		public AtomGdFeedLink FeedLink { get; private set; }
	}
}
