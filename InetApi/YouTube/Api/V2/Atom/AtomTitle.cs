...
{
	/// <summary>
	/// A class representing an xmlns:title atom.
	/// </summary>
	[Serializable]
	public sealed class AtomTitle : Atom
	{
		internal const string xmlPrefix = null;
		internal const string xmlName = "title";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomTitle(XElement element)
		...
		public static AtomTitle Parse(XElement element, bool mandatory)
		{
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomTitle ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomTitle.Parse(element.Element(AtomTitle.xmlPrefix, AtomTitle.xmlName), mandatory);
			}
