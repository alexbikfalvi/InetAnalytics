...
{
	/// <summary>
	/// A class representing a yt:lastName atom.
	/// </summary>
	[Serializable]
	public sealed class AtomYtLastName : Atom
	{
		internal const string xmlPrefix = "yt";
		internal const string xmlName = "lastName";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomYtLastName(XElement element)
		...
		public static AtomYtLastName Parse(XElement element, bool mandatory)
		{
			...
			return new AtomYtLastName(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomYtLastName ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomYtLastName.Parse(element.Element(AtomYtLastName.xmlPrefix, AtomYtLastName.xmlName), mandatory);
			}
