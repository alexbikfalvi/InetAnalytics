...
{
	/// <summary>
	/// A class representing a yt:aspectRatio atom.
	/// </summary>
	[Serializable]
	public sealed class AtomYtAspectRatio : Atom
	{
		internal const string xmlPrefix = "yt";
		internal const string xmlName = "aspectratio";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomYtAspectRatio(XElement element)
		...
		public static AtomYtAspectRatio Parse(XElement element, bool mandatory)
		{
			...
			return new AtomYtAspectRatio(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomYtAspectRatio ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomYtAspectRatio.Parse(element.Element(AtomYtAspectRatio.xmlPrefix, AtomYtAspectRatio.xmlName), mandatory);
			}
