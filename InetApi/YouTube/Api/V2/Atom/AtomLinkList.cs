...
{
	/// <summary>
	/// A class representing a list of xmlns:link atoms.
	/// </summary>
	public sealed class AtomLinkList : IEnumerable<AtomLink>
	{
		...
		private AtomLinkList(IEnumerable<XElement> elements)
		{
			foreach (XElement element in elements)
			{
				this.links.Add(AtomLink.Parse(element, true));
			}
		}
		...
		/// <returns>The atom list.</returns>
		public static AtomLinkList ParseChildren(XElement element)
		{
			// Parse the children elements.
			return AtomLinkList.Parse(element.Elements(AtomLink.xmlPrefix, AtomLink.xmlName));
		}
		...
		/// </summary>
		/// <returns>The enumerator.</returns>
		public IEnumerator<AtomLink> GetEnumerator()
		{
