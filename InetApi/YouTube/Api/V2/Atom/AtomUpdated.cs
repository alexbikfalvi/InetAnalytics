...
{
	/// <summary>
	/// A class representing an xmlns:updated atom.
	/// </summary>
	[Serializable]
	public sealed class AtomUpdated : Atom
	{
		internal const string xmlPrefix = null;
		internal const string xmlName = "updated";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomUpdated(XElement element)
		...
		public static AtomUpdated Parse(XElement element, bool mandatory)
		{
			...
			return new AtomUpdated(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomUpdated ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomUpdated.Parse(element.Element(AtomUpdated.xmlPrefix, AtomUpdated.xmlName), mandatory);
			}
