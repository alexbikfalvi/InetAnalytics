...
{
	/// <summary>
	/// A class representing a yt:movies atom.
	/// </summary>
	[Serializable]
	public sealed class AtomYtMovies : Atom
	{
		internal const string xmlPrefix = "yt";
		internal const string xmlName = "movies";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomYtMovies(XElement element)
		...
		public static AtomYtMovies Parse(XElement element, bool mandatory)
		{
			...
			return new AtomYtMovies(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomYtMovies ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomYtMovies.Parse(element.Element(AtomYtMovies.xmlPrefix, AtomYtMovies.xmlName), mandatory);
			}
