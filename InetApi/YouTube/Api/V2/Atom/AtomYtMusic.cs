...
{
	/// <summary>
	/// A class representing a yt:music atom.
	/// </summary>
	[Serializable]
	public sealed class AtomYtMusic : Atom
	{
		internal const string xmlPrefix = "yt";
		internal const string xmlName = "music";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomYtMusic(XElement element)
		...
		public static AtomYtMusic Parse(XElement element, bool mandatory)
		{
			...
			return new AtomYtMusic(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomYtMusic ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomYtMusic.Parse(element.Element(AtomYtMusic.xmlPrefix, AtomYtMusic.xmlName), mandatory);
			}
