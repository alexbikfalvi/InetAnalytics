...
{
	/// <summary>
	/// A class representing a yt:recorder atom.
	/// </summary>
	[Serializable]
	public sealed class AtomYtRecorded : Atom
	{
		internal const string xmlPrefix = "yt";
		internal const string xmlName = "recorded";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomYtRecorded(XElement element)
		...
		public static AtomYtRecorded Parse(XElement element, bool mandatory)
		{
			...
			return new AtomYtRecorded(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomYtRecorded ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomYtRecorded.Parse(element.Element(AtomYtRecorded.xmlPrefix, AtomYtRecorded.xmlName), mandatory);
			}
