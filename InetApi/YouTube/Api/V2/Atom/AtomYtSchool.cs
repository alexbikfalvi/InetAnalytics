...
{
	/// <summary>
	/// A class representing a yt:school atom.
	/// </summary>
	[Serializable]
	public sealed class AtomYtSchool : Atom
	{
		internal const string xmlPrefix = "yt";
		internal const string xmlName = "school";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomYtSchool(XElement element)
		...
		public static AtomYtSchool Parse(XElement element, bool mandatory)
		{
			...
			return new AtomYtSchool(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomYtSchool ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomYtSchool.Parse(element.Element(AtomYtSchool.xmlPrefix, AtomYtSchool.xmlName), mandatory);
			}
