...
{
	/// <summary>
	/// A class representing an openSearch:totalResults atom.
	/// </summary>
	[Serializable]
	public sealed class AtomOpenSearchTotalResults : Atom
	{
		internal const string xmlPrefix = "openSearch";
		internal const string xmlName = "totalResults";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomOpenSearchTotalResults(XElement element)
		...
		public static AtomOpenSearchTotalResults Parse(XElement element, bool mandatory)
		{
			...
			return new AtomOpenSearchTotalResults(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomOpenSearchTotalResults ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomOpenSearchTotalResults.Parse(element.Element(AtomOpenSearchTotalResults.xmlPrefix, AtomOpenSearchTotalResults.xmlName), mandatory);
			}
