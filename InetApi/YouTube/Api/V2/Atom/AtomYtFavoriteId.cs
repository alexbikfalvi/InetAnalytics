...
{
	/// <summary>
	/// A class representing a yt:favoriteId atom.
	/// </summary>
	[Serializable]
	public sealed class AtomYtFavoriteId : Atom
	{
		internal const string xmlPrefix = "yt";
		internal const string xmlName = "favoriteId";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomYtFavoriteId(XElement element)
		...
		public static AtomYtFavoriteId Parse(XElement element, bool mandatory)
		{
			...
			return new AtomYtFavoriteId(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomYtFavoriteId ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomYtFavoriteId.Parse(element.Element(AtomYtFavoriteId.xmlPrefix, AtomYtFavoriteId.xmlName), mandatory);
			}
