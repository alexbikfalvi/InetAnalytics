...
{
	/// <summary>
	/// A class representing a yt:playlistId atom.
	/// </summary>
	[Serializable]
	public sealed class AtomYtPlaylistId : Atom
	{
		internal const string xmlPrefix = "yt";
		internal const string xmlName = "playlistId";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomYtPlaylistId(XElement element)
		...
		public static AtomYtPlaylistId Parse(XElement element, bool mandatory)
		{
			...
			return new AtomYtPlaylistId(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomYtPlaylistId ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomYtPlaylistId.Parse(element.Element(AtomYtPlaylistId.xmlPrefix, AtomYtPlaylistId.xmlName), mandatory);
			}
