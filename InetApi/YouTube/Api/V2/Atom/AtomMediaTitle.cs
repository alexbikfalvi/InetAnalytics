...
{
	/// <summary>
	/// A class representing a media:title atom.
	/// </summary>
	[Serializable]
	public sealed class AtomMediaTitle : Atom
	{
		internal const string xmlPrefix = "media";
		internal const string xmlName = "atom";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomMediaTitle(XElement element)
		...
		public static AtomMediaTitle Parse(XElement element, bool mandatory)
		{
			...
			return new AtomMediaTitle(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomMediaTitle ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomMediaTitle.Parse(element.Element(AtomMediaTitle.xmlPrefix, AtomMediaTitle.xmlName), mandatory);
			}
