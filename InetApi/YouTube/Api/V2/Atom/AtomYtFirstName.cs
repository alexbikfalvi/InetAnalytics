...
{
	/// <summary>
	/// A class representing a yt:firstName object.
	/// </summary>
	[Serializable]
	public sealed class AtomYtFirstName : Atom
	{
		internal const string xmlPrefix = "yt";
		internal const string xmlName = "firstName";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomYtFirstName(XElement element)
		...
		public static AtomYtFirstName Parse(XElement element, bool mandatory)
		{
			...
			return new AtomYtFirstName(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomYtFirstName ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomYtFirstName.Parse(element.Element(AtomYtFirstName.xmlPrefix, AtomYtFirstName.xmlName), mandatory);
			}
