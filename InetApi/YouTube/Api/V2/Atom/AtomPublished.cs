...
{
	/// <summary>
	/// A class representing a published atom.
	/// </summary>
	[Serializable]
	public sealed class AtomPublished : Atom
	{
		internal const string xmlPrefix = null;
		internal const string xmlName = "published";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomPublished(XElement element)
		...
		public static AtomPublished Parse(XElement element, bool mandatory)
		{
			...
			return new AtomPublished(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomPublished ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomPublished.Parse(element.Element(AtomPublished.xmlPrefix, AtomPublished.xmlName), mandatory);
			}
