...
{
	/// <summary>
	/// A class representing a yt:captionTracks atom.
	/// </summary>
	[Serializable]
	public sealed class AtomYtCaptionTracks : Atom
	{
		internal const string xmlPrefix = "yt";
		internal const string xmlName = "captionTracks";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomYtCaptionTracks(XElement element)
		...
		public static AtomYtCaptionTracks Parse(XElement element, bool mandatory)
		{
			...
			return new AtomYtCaptionTracks(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomYtCaptionTracks ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomYtCaptionTracks.Parse(element.Element(AtomYtCaptionTracks.xmlPrefix, AtomYtCaptionTracks.xmlName), mandatory);
			}
