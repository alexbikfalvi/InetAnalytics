...
{
	/// <summary>
	/// A class representing a yt:uploaded atom.
	/// </summary>
	[Serializable]
	public sealed class AtomYtUploaded : Atom
	{
		internal const string xmlPrefix = "yt";
		internal const string xmlName = "uploaded";

		/// <summary>
		/// Private constructor.
		/// </summary>
		/// <param name="element">The XML element.</param>
		private AtomYtUploaded(XElement element)
		...
		public static AtomYtUploaded Parse(XElement element, bool mandatory)
		{
			...
			return new AtomYtUploaded(element);
		}
		...
		/// <param name="mandatory">Specified whether this element is mandatory.</param>
		/// <returns>The atom instance.</returns>
		public static AtomYtUploaded ParseChild(XElement element, bool mandatory)
		{
			...
			try
			{
				...
				return AtomYtUploaded.Parse(element.Element(AtomYtUploaded.xmlPrefix, AtomYtUploaded.xmlName), mandatory);
			}
