...
namespace InetCrawler.Database
{
	...
	public sealed class DbConfig : IDisposable
	{
		...
		public DbConfig(CrawlerConfig config, RegistryKey rootKey, string path)
		{
			this.dbSql = new DbConfigSql(config, rootKey, path + "\\Sql");
		...
		///// </summary>
		//public static string[] ServerTypeNames { get { return DbConfig.dbServerTypeNames; } }
		///// <summary>
