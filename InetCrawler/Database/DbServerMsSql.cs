...
namespace InetCrawler.Database
{
	...
	public sealed class DbServerMsSql : DbServerSql
	{
		...
		public DbServerMsSql(RegistryKey key, Guid id, string logFile)
			: base(key, id, logFile)
		{
		...
		/// </summary>
		public override DbConfig.DbServerType Type { get { return DbConfig.DbServerType.SqlMicrosoftSql; } }
		/// <summary>
