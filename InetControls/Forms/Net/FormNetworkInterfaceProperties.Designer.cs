namespace InetControls.Forms.Net
{
	partial class FormNetworkInterfaceProperties
	{
		...
		private void InitializeComponent()
		{
			...
			this.control = new InetControls.Controls.Net.ControlNetworkInterfaceProperties();
			this.SuspendLayout();
			// 
			// buttonClose
			// 
			...
			// 
			// FormNetworkInterfaceProperties
			// 
			...
			this.Name = "FormNetworkInterfaceProperties";
			this.ShowIcon = false;
		...
		private Controls.Net.ControlNetworkInterfaceProperties control;
