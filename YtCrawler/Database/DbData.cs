...
{
	/// <summary>
	/// A class representing a database table data.
	/// </summary>
	public class DbData
	{
		...
		/// <summary>
		/// Returns <b>true</b> if the table contains any data, or <b>false</b> otherwise.
		/// </summary>
		public bool HasData { get { return this.names != null; } }
